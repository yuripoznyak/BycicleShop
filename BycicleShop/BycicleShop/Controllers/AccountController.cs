    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Manage(/*ManageMessageId? message*/)
        {
            /*ViewBag.StatusMessage =
                ...
                : "";
            ViewBag.HasLocalPassword = OAuthWebSecurity.HasLocalAccount(WebMatrix.WebData.WebSecurity.GetUserId(User.Identity.Name));
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    User user = db.Entity.FirstOrDefault(u => u.UserName.ToLower() == model.UserName.ToLower());
                    // Check if user already exists
                    if (user == null)
                    {
                        // Insert name into the profile table
                        db.Entity.Add(new User { UserName = model.UserName });
                        db.SaveChanges();
