    ...
    public class CustomMembershipProvider : ExtendedMembershipProvider
    {
                                                  ...
                                                  object providerUserKey, out MembershipCreateStatus status)
        {
            ...
            using (var context = new UsersDataContext())
            {
                ...
                return new MembershipUser(System.Web.Security.Membership.Provider.Name, user.UserName, user.UserId, user.EmailAdress, null,
        ...
        public override MembershipUser GetUser(object providerUserKey, bool userIsOnline)
        {
            ...
            using (var context = new UsersDataContext())
            {
                ...
                if (user != null)
                {
                    ...
                    return new MembershipUser(System.Web.Security.Membership.Provider.Name, user.UserName, user.UserId, user.EmailAdress,
